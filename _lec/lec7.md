...
_We_ (in the book) will represent a substitution as a list of bindings
(under restrictions). Here is an example:

   ```lisp
   ((X T) (Y NIL) (W T))
   ```

This is a particularly clever choice of notation as we will soon
see. This is convenient for we ACL2ers! 
