...
# Proposal Status update. 
  ...
  - Read through them all. Don't have grades back.

  - Doing a second pass, prioritizing meeting w/you all in real time. 

  - Stuck on a couple of issues.

## Human subjects

  If you are at all considering research with human subjects---be it
  surveys or what have you, and you didn't mention it. Please do so. 
  
  If you have not already see NEU's [policy on the
  aforementioned](https://research.northeastern.edu/app/uploads/sites/4/2019/05/Policy_on_Classroom_Research.pdf)

# Let's recap where we're at! 

1. Provide a measure function for the following: 

2. After providing it, pen-and-paper prove the necessary conjecture(s)
   to show that the function terminates via your measure.


## Let's recap a HW question about which folk have been wondering
...
### As a reminder: 
  ...
  A definition is /admissible/ when ...
   ...
   4. A *total*, computable function. Terminates on (acceptable)
	  input. This means that if you evaluate the function on any
	  inputs that satisfy the input contract, the function will
	  terminate.
	  (WE SHOW)
