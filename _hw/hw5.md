 ...
 * Submit `hw5.lisp` (the hw file) on the homework server in the
...
## Further technical and pedantic instructions: 
 ...
 - Make sure ACL2s accepts the entire file. Comment out the
   pen-and-paper proofs (that we mechanised with andrew walter's page).
