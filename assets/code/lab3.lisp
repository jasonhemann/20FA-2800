#|
 ...
 Please do as much of this as possible before labs.
...
Next to "True?", you should write "Yes" or "No" (not, btw, in the
double quotation marks, that is to distinguish [use from
mention](https://en.wikipedia.org/wiki/Use-mention). Beneath the
word "Formalize": 

If you marked "Yes": you should write a (test? ...)  with a
...
If you marked "No": you should write a let binding giving values to
...
#|
 ...
 objects of that datatype. See Section 2.13 of the lecture notes. Use
 this template to define functions such as srpneval.
...
#|
 ...
 Mentally, travel back in time to grade school. Specifically, your
