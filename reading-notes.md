...
Readings will come from the following draft textbook chapters. I suggest that *if* you read online and *if* you take digital notes, that we all use the included collaborative note-taking software. 
  ...
  3.  [Equational Reasoning](https://via.hypothes.is/https://www.khoury.northeastern.edu/~pete/courses/Logic-and-Computation/2020-Spring/rapeq.pdf)
  4.  [Definitions and Termination](https://via.hypothes.is/https://www.khoury.northeastern.edu/~pete/courses/Logic-and-Computation/2020-Spring/rapdt.pdf)
  5.  [Induction](https://via.hypothes.is/https://www.khoury.northeastern.edu/~pete/courses/Logic-and-Computation/2020-Spring/rapind.pdf)
  ...
  9.  [An ACL2 Reference](/jhemann/20FA-2800/acl2s-reference/)
